...
<section class="container-section1">
        <div class="box-img-s1">
            <a href="">
            <div class="resep-button-s1">
                ...
                <div class="resep-text-s1">easy chicken dinner</div>
            </div>
            <div>
                <img src={Center} alt="resep ayam krispi" class="center-img-s1"/>
                <img src={TopRight} alt="resep ayam jeruk" class="top-right-img-s1"/>
                <img src={Left} alt="beberapa resep ayam" class="left-img-s1"/>
                <img src={BottomRight} alt="resep nasi ayam" class="bottom-right-img-s1"/>
            </div>
            </a>
        </div>
    <div class="container-text-s1">
